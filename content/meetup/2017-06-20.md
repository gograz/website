...
For signing tokens Mathias mentioned a [talk](https://youtu.be/67mezK3NzpU) where the speaker used public key systems for making verifications easy for services without having to rely on a shared secret.
